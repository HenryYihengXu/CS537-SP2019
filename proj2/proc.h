...
struct proc {
  ...
  int tmpticks[4];             // number of ticks this process has accumulated at each of 4 priorities
  int wait_ticks[4];           // number of ticks this process has waited before being scheduled at each 4 priorities
  int tmpwait_ticks[4];        // number of ticks this process has waited before being scheduled at each 4 priorities
};

//structure for recording scheduling processes information
struct pstat {
